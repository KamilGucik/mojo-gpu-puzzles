...
fn conv_1d_block_boundary[
    ...
    global_i = block_dim.x * block_idx.x + thread_idx.x
    local_i = thread_idx.x
    shared_input = tb[dtype]().row_major[TPB + CONV_2 - 1]().shared().alloc()
    shared_conv = tb[dtype]().row_major[CONV_2]().shared().alloc()
    ...
    if local_i < CONV_2 - 1:
        ...
        if next_idx < SIZE_2:
            shared_input[local_i + TPB] = a[global_i + TPB]
        else:
            shared_input[local_i + TPB] = 0
